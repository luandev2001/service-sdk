...
public class GreaterThanStrategy extends ComparableStrategy {

    public GreaterThanStrategy(From<?, ?> from, CriteriaBuilder builder) {
        super(from, builder);
    }
    ...
    public AttributeAction.Operator getOperator() {
        return AttributeAction.Operator.gt;
    }
}
